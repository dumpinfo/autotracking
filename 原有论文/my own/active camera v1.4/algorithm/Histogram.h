...
EXTERN_C IplImage*	his_GetBackProjImage();
...
EXTERN_C void		his_TrackNextFrame(IplImage* inImg, RECT inRect, TkResult *outResult);
EXTERN_C void		his_TrackInit_Bins(IplImage *inImg, IplImage *inMask, RECT inRect, int nbins1, int nbins2, int nbins3);
...
EXTERN_C void		his_TrackCleanUp();