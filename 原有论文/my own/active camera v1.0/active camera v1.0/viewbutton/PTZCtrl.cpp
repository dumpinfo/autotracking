	...
	while(true)
	{
		...
		if(nAction!=nLastAction)
		{
			if(nAction == PTZ_LEFT)
			{
				...
				{
					VISCA_set_pantilt_left(pThis->pVISCAinter, pThis->pCamera, 5,5);
//					pThis->m_pView->SetTimer(2,200,NULL);
			...
			else if(nAction == PTZ_STOP)
			{
				if(pThis->pVISCAinter)
				{
					...
					VISCA_set_pantilt_stop(pThis->pVISCAinter,pThis->pCamera,5,5);
				}
			}
			else if(nAction == PTZ_RIGHT)
			{
				if(pThis->pVISCAinter)
				{
					VISCA_set_pantilt_right(pThis->pVISCAinter, pThis->pCamera, 5,5);
//					pThis->m_pView->SetTimer(2,200,NULL);
				}			
			}
			else if(nAction == PTZ_UP)
			{
				if(pThis->pVISCAinter)
				{
					VISCA_set_pantilt_up(pThis->pVISCAinter, pThis->pCamera, 5,5);
//					pThis->m_pView->SetTimer(2,200,NULL);
				}			
			}
			else if(nAction == PTZ_DOWN)
			{
				if(pThis->pVISCAinter)
				{
					VISCA_set_pantilt_down(pThis->pVISCAinter, pThis->pCamera, 5,5);
//					pThis->m_pView->SetTimer(2,200,NULL);
				}			
			}
			else if(nAction == PTZ_ZOOMIN)
			{
				if(pThis->pVISCAinter)
				{
					VISCA_set_zoom_wide_speed(pThis->pVISCAinter, pThis->pCamera,5);		
//					pThis->m_pView->SetTimer(3,200,NULL);				
			...
			else if(nAction == PTZ_ZOOMOUT)
			{
				if(pThis->pVISCAinter)
				{
					VISCA_set_zoom_tele_speed(pThis->pVISCAinter, pThis->pCamera,5);					
//					pThis->m_pView->SetTimer(3,200,NULL);	
				}			
			}
